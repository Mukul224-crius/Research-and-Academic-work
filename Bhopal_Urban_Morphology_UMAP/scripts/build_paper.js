...
const methodsChildren = [
  ...
  flag("the exact QGIS Field Calculator expression syntax for obf_n, bld_n, and wsf_n was not recovered from the delivered files -- the mathematical form (max-normalization) is independently verified against all grid cells to within rounding error, but the literal expression text used in QGIS is not confirmed"),
